        ...
        <li className="relative flex items-center justify-between px-2 py-6 border-b">
            {
                editMode
                    ? <div className="w-full flex items-center justify-between">
                        <input type="text" defaultValue={todo?.title} onChange={() => {
                        }} onKeyDown={editTodoHandler} className="w-full px-4 py-2 border border-gray-200 rounded "/>
                    ...
                    : <div className="w-full flex items-center justify-between">
                        ...
                        <button type="but ton" className="absolute right-0 flex items-center space-x-1">
